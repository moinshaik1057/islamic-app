...
//                                 <img src="public/moon-phases/full-moon.png" alt="moon" />
//                             </div>
...
// import { useSelector } from 'react-redux';
// import moonPhaseIcons from '../../utils/moonPhases';
// import fullMoonImage from '../../assets/moon-phases/full-moon.png'; // Adjust the path as necessary
...
//                             <div className='col-3 align-self-center'>
//                                 <img src={getMoonPhaseIcon(moon_phase)} alt="moon phase icon" />
//                                 <img src="/moon-phases/full-moon.png" alt="moon icon" />
//                                 <img src={fullMoonImage} alt="moon icon" />
//                             </div>
//                             <div className='col-9 font-sm'>
//                                 <div className='table-responsive'>
//                                     <table className='table table-sm table-borderless mb-0 font-sm-2'>
